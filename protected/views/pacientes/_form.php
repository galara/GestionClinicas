                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <?php echo $form->dropDownList($model, 'id_estadocivil', array(CHtml::listData(EstadoCivil::model()->findAll(), 'id', 'estado_civil')), array('class' => 'form-control')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <?php echo $form->dropDownList($model, 'id_prevision', array(CHtml::listData(Prevision::model()->findAll(), 'id', 'prevision')), array('class' => 'form-control')) ?>
                            <?php echo $form->error($model, 'fecha_nacimiento',  array('class' => 'text-danger')); ?>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <?php echo $form->textField($model, 'celular_contacto', array('size' => 13, 'maxlength' => 13, 'class' => 'form-control')); ?>
