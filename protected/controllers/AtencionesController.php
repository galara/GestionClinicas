...
class AtencionesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'nueva', 'cargardiagnosticos', 'editar', 'ver'),
				'users'=>array('*'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('Atenciones');
	...
	{
		$model=new Atenciones('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Atenciones']))
			$model->attributes=$_GET['Atenciones'];
